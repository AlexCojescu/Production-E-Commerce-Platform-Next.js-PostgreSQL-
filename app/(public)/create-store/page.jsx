    ...
    const fetchSellerStatus = async () => {
        ...
        try {
            ...
            if(['approved', 'rejected', 'pending'].includes(data.status)){
                ...
                switch (data.status) {
                    case "approved":
                        setMessage("Your store has been approved, you can now add your pieces to your store from the dashboard")
                    ...
                    case "rejected":
                        ...
                        break;
                    case "pending":
                        setMessage("Your store request is pending, contact the admin for more details")
                        setTimeout(()=>router.push("/store"), 5000)
                        break;
