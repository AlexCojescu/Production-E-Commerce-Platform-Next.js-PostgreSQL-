    ...
    <div className="min-h-[70vh] bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-6 gap-3">
          <h1 className="text-2xl text-slate-700 flex items-center gap-2">
            All <span className="text-slate-900 font-medium">Products</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-black bg-white"
            >
            ...
            <button
              ...
              className="md:hidden flex items-center gap-2 px-3 py-2 border border-gray-200 rounded-lg text-sm hover:bg-gray-50 transition bg-white"
            >
        ...
        <div className="flex gap-6 lg:gap-8">
          ...
          <div className="flex-1">
            {sortedProducts.length === 0 ? (
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-28">
