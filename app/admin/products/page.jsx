...
export default function AdminProducts() {
  ...
  }, [user]) // user.id if you want to be stricter
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-800 text-sm"
            />
            {searchQuery && (
              <button
                type="button"
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 py-2 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-800 text-sm"
            >
            ...
            <table className="w-full text-left text-sm">
              <thead className="bg-slate-50 text-gray-700 uppercase tracking-wider border-b border-slate-200">
                <tr>
                  ...
                  <th
                    scope="col"
                    className="px-4 py-3 font-semibold hidden lg:table-cell"
                  >
                    Brand
                  </th>
                  <th
                    ...
                    <td className="px-4 py-4">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        >
                          ...
                          />
                          <div className="w-11 h-6 bg-slate-300 rounded-full peer peer-checked:bg-red-600 transition-colors duration-200" />
